...
router.post('/menu-items', authenticateToken, requireVendor, menuController.createMenuItem);
router.put('/menu-items/:id', authenticateToken, requireVendor, menuController.updateMenuItem);
